...
import { SkinToneResult } from "./skinTone";
...
interface MakeupStore {
  ...
  // Before/After long-press preview
  viewMode: "before" | "after";
  setViewMode: (mode: "before" | "after") => void;

  // ⭐ Skin tone (NEW)
  skinTone: SkinToneResult | null;
  setSkinTone: (result: SkinToneResult | null) => void;
...
export const useMakeupStore = create<MakeupStore>((set) => ({
  ...
  // ⭐ Before/After long-press preview initial state
  viewMode: "after",
  setViewMode: (mode) => set({ viewMode: mode }),

  // ⭐ Skin tone initial state
  skinTone: null,
  setSkinTone: (result) => set({ skinTone: result }),
